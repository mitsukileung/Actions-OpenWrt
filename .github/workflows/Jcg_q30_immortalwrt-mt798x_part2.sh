...
name: Jcg_q30_immortalwrt-mt798x
...
env:
  ...
  CONFIG_FILE: Jcg_q30_immortalwrt-mt798x.config
  DIY_P1_SH: Jcg_q30_immortalwrt-mt798x_part1.sh
  DIY_P2_SH: Jcg_q30_immortalwrt-mt798x.sh
  RELEASE_TAG: Jcg_q30_immortalwrt-mt798x
  UPLOAD_BIN_DIR: true
  ...
  build:
    ...
    - name: Initialization environment
      ...
      run: |
        ...
        sudo -E apt-get -qq install $(curl -fsSL https://raw.githubusercontent.com/mitsukileung/Actions-OpenWrt/main/depends-ubuntu-2004)
