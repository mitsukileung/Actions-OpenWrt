...
wget -O target/linux/mediatek/dts/mt7981b-cmcc-rax3000m-emmc-mtk.dts https://raw.githubusercontent.com/mitsukileung/Actions-OpenWrt/refs/heads/main/mi_patch/mt7981b-cmcc-rax3000m-emmc-mtk.dts
